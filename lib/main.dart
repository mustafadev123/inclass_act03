            ...
            Wrap(
              ...
              children: [
                TactileButton(
                  ...
                  onPressed: () => _triggerAction("SPECTRUM SCAN"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("AUDIO PULSE"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("CAPACITOR CHARGE"),
                ),
                TactileButton(
                  icon: Icons.eject,
                  label: "EJECT",
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("SIGNAL EJECT"),
                ),
              ],
            ),
